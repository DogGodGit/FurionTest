...
public sealed class RabbitMQEventSourceStorer : IEventSourceStorer, IDisposable
{
    ...
    public RabbitMQEventSourceStorer(ConnectionFactory factory, string routeKey = "EventHub", int capacity = 3000)
    {
        // 配置通道，设置超出默认容量后进入等待
        ...
        consumer.Received += (ch, ea) =>
        {
            ...
            var eventSource = JSON.Deserialize<RabbitMQEventSource>(stringEventSource);
